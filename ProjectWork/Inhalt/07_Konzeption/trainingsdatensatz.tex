...
\begin{figure}[H]
	\subfigure[Objekte im Regal]{\includegraphics[width=0.45\textwidth]{Bilder/dataset5.jpg}}\hfill
	\subfigure[Objekte im Getränkekasten]{\includegraphics[width=0.45\textwidth]{Bilder/dataset6.jpg}}\hfill
