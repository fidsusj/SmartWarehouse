...
\begin{figure}[H]
	\centering
	\subfigure[Detektion verdeckter Objekte]{\includegraphics[width=0.30\textwidth]{Bilder/verdeckt.jpeg}}
	\hspace{2cm}
	\subfigure[Detektion aus extremen Blickwinkeln]{\includegraphics[width=0.30\textwidth]{Bilder/winkel.jpeg}}
