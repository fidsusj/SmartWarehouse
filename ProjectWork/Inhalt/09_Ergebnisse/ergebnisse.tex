...
TODO:
 - Vergleiche wie bei SSD (siehe Bewertungskriterien)
...
Eine Epoche lokales Training mit anschließendem Testen des Durchlaufs beim \textit{SSD} auf einer \textit{NVIDIA GTX 1080} dauert im Schnitt neun Minuten. Die Messung basiert auf einer Batch Größe von 16 Bildern bei insgesamt 998 Bildern pro Epoche. Insgesamt wurden 16,5 Stunden zum Erstellen eines Modells mit dem \textit{SSD} benötigt. Bei einer Unterbrechung des Trainings kann durch Ablage von sogenannten Modell-Checkpoints zu einem späteren Zeitpunkt mit dem Trainings fortgefahren werden. 

TODO:
	- YOLO Trainingsverhalten
