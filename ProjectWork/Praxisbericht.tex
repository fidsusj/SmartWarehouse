...
\input{Inhalt/06_StandDerTechnik/standdertechnik}

\input{Inhalt/07_Konzeption/variantendiskussion}
\input{Inhalt/07_Konzeption/bewertungskriterien}

\input{Inhalt/08_Implementierung/implementierung}

\input{Inhalt/09_Bewertung/bewertung}

\input{Inhalt/10_Zusammenfassung_Ausblick/zusammenfassung_ausblick}
